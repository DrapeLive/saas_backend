    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slabs', to='commissions.commissionplan')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('paid', 'Paid'), ('disputed', 'Disputed'), ('adjusted', 'Adjusted')], default='pending', max_length=15)),
                ...
                ('plan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='commissions.commissionplan')),
            ],
            options={
                'db_table': 'commissions_entry',
                'indexes': [models.Index(fields=['agent', 'status', 'settlement_month'], name='commissions_agent_i_a8bade_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_rates', to='commissions.commissionplan')),
            ],
            options={
