    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_commission_pct', models.DecimalField(blank=True, decimal_places=2, help_text='e.g., Mens=2%, Kids=3%, Ladies=4%', max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hsn_code', models.CharField(blank=True, help_text='HSN code for GST', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code', models.ImageField(blank=True, null=True, upload_to='products/qr/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserved_qty', models.IntegerField(default=0, help_text='Reserved for pending orders')),
                ('reorder_level', models.PositiveIntegerField(default=10)),
                ('is_active', models.BooleanField(default=True)),
                ('color_variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sizes', to='products.colorvariant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('movement_type', models.CharField(choices=[('in', 'Stock In'), ('out', 'Stock Out (Sale)'), ('adjustment', 'Manual Adjustment'), ('return', 'Customer Return'), ('reserve', 'Reserved (Order)'), ('release', 'Released (Cancelled)'), ('damage', 'Damaged/Written Off')], max_length=15)),
                ...
                ('variant_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movements', to='products.variantsize')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['variant_size', 'created_at'], name='products_st_variant_2958c2_idx'),
        ),
    ]
